...
var rand = require('random-key'),
    logger = require('./logger.js')('cat-client'),
...
function newTransaction(options) {
    ...
    t.addData = function (data) {
        ...
        try {
            ...
            logger.error('Add transaction data error. Unsupported error caught. ' + err);
        }
    };
...
function logEvent(options) {
    ...
    try {
        ...
        logger.error('Log event(uid = ' + uid + ') error. Unsupported error caught. ' + err);
    }
}
...
function logError(options) {
    ...
    try {
        ...
        logger.error('Log error(uid = ' + uid + ') error. Unsupported error caught. ' + err);
    }
}
